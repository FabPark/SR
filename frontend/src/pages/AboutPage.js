...
function About() {
  return (
    <div className="bg-white flex justify-center items-center">
      ...
      <div className="w-1/2 sm:w-3/4 flex-col justify-center items-center bg-white p-6 md:p-8 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
        <br />
        <div>
